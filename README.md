...
| Logger Factory Class              | This field identifies the class to be used as a logger factory, which can be dynamically loaded using the `rflib_LoggerUtil.getFactory()` method. This class will then be instantiated and used to create the logger instance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |                   | rflib_DefaultLoggerFactory               | rflib_DefaultLoggerFactory       |
