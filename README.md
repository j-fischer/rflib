...
- Real-time log notifications to [Slack](https://github.com/j-fischer/rflib/wiki/Logging-to-Slack), [Microsoft Teams](https://github.com/j-fischer/rflib/wiki/Logging-to-Microsoft-Teams), and [Google Chat](https://github.com/j-fischer/rflib/wiki/Logging-to-Google-Chat) for log events at or above a configurable threshold
- Vendor-neutral log forwarding to [Azure Application Insights](https://github.com/j-fischer/rflib/wiki/Logging-to-Azure-App-Insights) and [OpenTelemetry (OTLP/HTTP)](https://github.com/j-fischer/rflib/wiki/Logging-to-OpenTelemetry) backends such as [AWS CloudWatch](https://github.com/j-fischer/rflib/wiki/Logging-to-AWS-CloudWatch) and OpenTelemetry collectors
...
- [Server-side logging for Node.js and Lightning Web Runtime (LWR)](https://github.com/j-fischer/rflib/wiki/Getting-Started-with-the-Node-LWR-Logger) apps via the `rflib` npm package
...
```
rem RFLIB 11.1.0
sf package install --package 04tKY0000005SoOYAU --target-org <your org alias>
